...
public class FileCharsetTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //
//        System.out.println(codeString("F:\\workspace\\shang1\\java7\\java7\\nio2\\FilesTest.java"));

        File file1 = new File("F:\\workspace\\shang1\\src\\com\\shang\\excel\\ExcelUtil.java");

        //
        System.out.println("文件编码:" + new FileCharsetTest().guessFileEncoding(file1));
